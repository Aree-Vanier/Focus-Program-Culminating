...
public class InputManager : MonoBehaviour {
	...
	public enum Button{FIRE,GEAR,CANOPY,EJECT,TOGGLE_WEAPONS,WEAPON_LEFT,WEAPON_RIGHT,FIRE_CANNON,CHANGE_CAMERA};
	static string[] joyButtons = {"joystick button 1", "joystick button 3","joystick button 6","joystick button 7","joystick button 2","joystick button 4","joystick button 5","joystick button 0","joystick button 8"};
	static KeyCode[] keyButtons = {KeyCode.Space, KeyCode.G, KeyCode.C, KeyCode.F1, KeyCode.LeftAlt, KeyCode.LeftBracket, KeyCode.RightBracket, KeyCode.R, KeyCode.V};
